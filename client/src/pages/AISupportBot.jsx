    ...
    <div className="p-4 sm:p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        <div className="flex flex-col h-[36rem] sm:h-[38rem] bg-white shadow rounded-lg">
          ...
          <div className="flex-1 h-80 sm:h-96 overflow-y-auto p-3 sm:p-4 space-y-3 sm:space-y-4 bg-gray-50">
              ...
              >
                <div
                  className={`px-3 py-2 sm:px-4 sm:py-2 rounded-lg max-w-xs ${
                    msg.sender === "user" ? "bg-gray-200" : "bg-green-600 text-white"
                  }`}
                >
                  {msg.text}
                </div>
          ...
          <div className="p-3 sm:p-4 border-t flex gap-2">
            <input
              className="border rounded w-full px-3 py-2 sm:px-4 sm:py-2 text-sm sm:text-base"
            ...
            <table className="w-full text-sm sm:text-base border border-gray-200 border-collapse">
              <thead>
                <tr className="border-b border-gray-200 text-left">
                  <th className="py-2 px-2 border-r border-gray-200">Date</th>
                  <th className="py-2 px-2 border-r border-gray-200">Customer Message</th>
                  <th className="py-2 px-2 border-r border-gray-200">AI Response</th>
